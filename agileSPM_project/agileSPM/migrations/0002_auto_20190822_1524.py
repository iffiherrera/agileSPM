# Generated by Django 2.2.3 on 2019-08-22 15:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_signature2', models.DateField(default=datetime.date.today)),
                ('updated', models.DateTimeField(default=datetime.date.today, verbose_name='Last updated')),
                ('author', models.OneToOneField(db_column='user', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
